package com.infy.ci.complexamqpservice;
...
@Component
@Configuration
@RequestMapping("/complextestdata")
public class ComplexAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(ComplexAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/complex/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/complex/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/complex/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/complex/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/complex/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/complex/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
